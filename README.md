...
SBL is a lightweight, open protocol designed to connect cameras, encoders, and production software with glass-to-glass latency under 300ms on standard WiFi. It extends WebRTC's media transport with a production-grade control layer: tally signaling, scene metadata, transport controls, and zero-config discovery.
...
|----------|--------------|-----------|--------------------|-----------|---------| 
| **SBL**  | **<300ms**   | 2–50 Mbps | ✓ Tally, Scene, TC | mDNS + QR | **Apache 2.0** |
...
4. The source appears immediately at <300ms latency
